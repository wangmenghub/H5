var Zepto = function () {
    ...
    return G.matches = function (t, e) {
        ...
        position: function () {
            if (this.length) {
                var t = this[0], e = this.offsetParent(), n = this.offset(), i = _.test(e[0].nodeName) ? {top: 0, left: 0} : e.offset();
...
window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto), function (t) {
    ...
    }, g = {}, v = {}, y = "onfocusin" in window, b = {focus: "focusin", blur: "focusout"}, w = {
    ...
    function e(n) {
        var i = [["resolve", "done", t.Callbacks({once: 1, memory: 1}), "resolved"], ["reject", "fail", t.Callbacks({
            once: 1,
            memory: 1
