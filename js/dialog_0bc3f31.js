var Dialog = function () {
    ...
    this.win.resize(function () {
        t.overlay.css({height: t.doc.height()})
    })
};
Dialog.prototype = {
    addOverlay: function () {
...
var alert_v = function (t, i, e) {
    ...
    var n = $('<div style="width:200px;background:#2f465c;border:1px solid #3b8cbd;border-radius:5px;padding:20px;"><div style="text-align:center;color:#fff">' + t + '</div><div style="text-align:center;margin-top:15px;"><a href="javascript:;" style="background:#14547a;width:100px;height:25px;display:inline-block;line-height:25px;color:#fff;border:1px solid #1775ae;border-radius:5px" id="closeAlert">' + o + "</a></div></div>"), r = (new Dialog).setBody(n).show();
    $("#closeAlert").on("tap", function () {
        r.remove(), r = null, e && e()
    })
}, Loading = function (t) {
    this.html = $('<div style="width:200px;background:#2f465c;border:1px solid #3b8cbd;border-radius:5px;padding:20px;"><div style="text-align:center;color:#fff">' + t + "</div></div>"), this.dig = null
};
